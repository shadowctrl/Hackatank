      ...
      <div className="parent-software">
        ...
        <div className="software-container">
          <div
            ...
            onClick={() => handleSoftwareView("hd1")}
            id="hd1"
          >
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd2")}
            id="hd2"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd3")}
            id="hd3"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd4")}
            id="hd4"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd5")}
            id="hd5"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd6")}
            id="hd6"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd7")}
            id="hd7"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd8")}
            id="hd8"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd9")}
            id="hd9"
          >
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd10")}
            id="hd10"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd11")}
            id="hd11"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd12")}
            id="hd12"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd13")}
            id="hd13"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd14")}
            id="hd14"
          >
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd15")}
            id="hd15"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd16")}
            id="hd16"
          >
            <h1 className="software-content-title">
          ...
          <div
            className="software-content"
            onClick={() => handleSoftwareView("hd17")}
            id="hd17"
          >
            <h1 className="software-content-title">
              Redefining Education through Technology
